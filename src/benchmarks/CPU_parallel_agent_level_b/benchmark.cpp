...
int main() {
    ...
    std::ofstream out("results/benchmarks_cpu_v3_threads.csv");

    if (!out.is_open()) {
        std::cerr << "Error: could not open results/benchmarks_cpu_v3_threads.csv\n";
        return 1;
    }
    ...
    std::cout << "Benchmark completed. Results written to results/benchmarks_cpu_v3_threads.csv\n";
